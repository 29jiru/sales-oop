...
<body>
    <nav class="navbar navbar-expend-lg navbar-dark bg-black" style="margin-bottom: 80px;">
        <div class="container">
                    ...
                    ?>
                        <tr>
                            <td>
                                ...
                                if ($user['photo']) {
                                ?>
                                    <img src="../assets/images/<?= $user['photo'] ?>" alt="<?= $user['photo'] ?>" class="d-block mx-auto dashboard-photo" style="height: 100px; width: 100px">
                                <?php
                                } else {
                                ?>
